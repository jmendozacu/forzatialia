...
if($mainpage) {
    ...
    {
        $booster->aitDebugTop("AITOC MAGENTO BOOSTER DISABLED.");
    }
    ...
    if($booster->_enableCache && $booster->_canCachePage==false)
    {
        ...
        {
            $booster->aitDebugTop("ADMIN AREA IS NOT CACHED");
        }
        else
        {
            $booster->aitDebugTop("PAGE CANNOT BE CACHED. CHECK AITOC MAGENTO BOOSTER EXCLUSIONS");
        }
    }
}
/**
