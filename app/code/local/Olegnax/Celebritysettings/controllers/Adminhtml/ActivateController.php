	...
	public function activateAction()
    {
        ...
        try {
	        foreach ($stores as $store) {
                ...
                //design > footer
                Mage::getConfig()->saveConfig('design/footer/copyright', 'Celebrity Theme &copy; '.date('Y').' <a href="//olegnax.com/products/magento/" >Premium Magento Themes</a> by Olegnax', $scope, $store);
