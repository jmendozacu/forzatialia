 ...
 */
 class ik_walker extends Walker_Nav_Menu{
	...
	function start_lvl(&$output, $depth) {
		//echo $depth;//shown-sub
		$output .= '<div class="sub-wrapper">
						 <ul class="level0"><li>';
	}
	...
	function start_el(&$output, $item, $depth, $args) {
     ...
     // echo $item->title;
        ...
        $home_link_class = ( is_front_page() ? ' class="home level0 level-top first parent "' : '' );
        // Build home link markup
        $home_link = '<li' . $home_link_class . '>';
        $home_link .= $args->before;
        $home_link .= '<a class="level-top home-new" href="' . home_url() . '">';
...
function wp_nav_menu( $args = array() ) {
	...
	$defaults = array( 'menu' => '', 'container' => 'div', 'container_class' => '', 'container_id' => '', 'menu_class' => 'menu', 'menu_id' => 'nav',
