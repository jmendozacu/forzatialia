...
class Mage_Sitemap_Model_Sitemap extends Mage_Core_Model_Abstract
{
    ...
    public function generateXml()
    {
        ...
        $io->streamWrite('<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>http://www.forzaitalia.com.au/</loc><lastmod>2013-05-20</lastmod><changefreq>daily</changefreq><priority>1.0</priority></url>');
