...
class Olegnax_Celebritysettings_Block_Adminhtml_System_Config_Form_Field_Font extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="celebritysettings_gfont_preview" style="font-size:20px; margin-top:5px;">The quick brown fox jumps over the lazy dog</div>
		<script>
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
                this.fontElement = $("celebritysettings_celebritysettings_appearance_font");
                this.previewElement = $("celebritysettings_gfont_preview");
                this.loadedFonts = "";
