...
class Olegnax_Celebritysettings_Model_Settings extends Mage_Core_Model_Abstract
{
    /**
     * theme settings
     *
    ...
    public function __construct()
    {
	    ...
	    $filePath = Mage::getBaseDir().'/app/code/local/Olegnax/Celebritysettings/etc/celebrity.xml';
