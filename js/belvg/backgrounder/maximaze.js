// Copyright В©2011 Aaron Vanderzwan, by Aaron Vanderzwan
  ...
  function _start_timer() {
	...
	function runSlideChange(currentSlide){
		if(currentSlide < opts.imageArray.length-1){
      	...
      	$('.slide-'+lastSlide).css({'z-index':opts.zIndex-1}).fadeOut(2500);
      	$('.slide-'+currentSlide).css({'z-index':opts.zIndex}).fadeIn(2500);
      	if(opts.slideShowTitle){
